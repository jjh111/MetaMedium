...
| **3** | Framework → "Negotiation paradigm" | Draw a diamond. Both readings are held (triangle 0.61 / rectangle 0.58) and *neither* is snapped. Draw a box; it is offered clean. | Multi-parse; deferred commitment; nothing wins by silencing. |
